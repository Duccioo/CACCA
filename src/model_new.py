...
class ConditionalAutoencoder(nn.Module):
    ...
    def __init__(self, vocab_size, args):
        ...
        self.to_latent = nn.Linear(2*self.unit_size, self.latent_size)
    ...
    def forward(self, x, c, lengths):
        ...
        z = self.to_latent(torch.cat([h_last, h_n[-2]], dim=-1))                   # (B, latent_size)
    ...
    # ---------------------------------------------------------------
    def sample_old(self, latent_vector, c, start_token, seq_length=120,
