...
def smiles_from_zinc_graph(data):
    ...
    atom_types = ['C', 'O', 'N', 'F', 'H', 'S', 'Cl', 'Br', 'I', 'P'] # Tipi di atomi in ZINC
    ...
    # Aggiungi legami
    edge_types = [Chem.rdchem.BondType.SINGLE, Chem.rdchem.BondType.DOUBLE, Chem.rdchem.BondType.TRIPLE, Chem.rdchem.BondType.AROMATIC]
